...
render() {
  return (
   <div className='form-block'>
    ...
    <input value={this.state.value} onChange={this.setInputText1} id='fnumber' type="number" />
    <label htmlFor="snumber">Second Number</label>
    <input value={this.state.value2a} onChange={this.setInputText2} id='snumber' type="number" />
    <label htmlFor="answer">Answer</label>
    <input value={this.state.answer} id='answer'disabled='true' type="number" />
    <Buttons
     onBtns={this.handleBtns}
    />
   </div>
  )
 }
